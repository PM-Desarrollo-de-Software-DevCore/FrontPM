...
const esToEnEntries: Array<[string, string]> = [
  ...
  ["Fill out the essentials first, then open advanced settings if you need budget or billing details.", "Completa los datos esenciales primero y abre la configuración avanzada si necesitas presupuesto o facturación."],
  ["Project basics", "Información esencial"],
  ["What defines the project and its timeline.", "Qué define el proyecto y su cronograma."],
  ["Required", "Requerido"],
  ...
  ["Ranked by skill fit and completed tasks", "Ordenadas por ajuste de habilidades y tareas completadas"],
  ["Analyzing...", "Analizando..."],
  ["Generating recommendations...", "Generando recomendaciones..."],
  ["Write a stronger title or description to get recommendations.", "Escribe un título o descripción más sólidos para obtener recomendaciones."],
  ["Project Users", "Usuarios del proyecto"],
  ["Search by name or email", "Buscar por nombre o correo"],
  ["Advanced settings", "Configuración avanzada"],
  ["Optional fields for planning, finance, and billing.", "Campos opcionales para planificación, finanzas y facturación."],
  ["Estimated sprints", "Sprints estimados"],
  ["Budget", "Presupuesto"],
  ["Monthly cost", "Costo mensual"],
  ["Billing model", "Modelo de facturación"],
  ["Fixed price", "Precio fijo"],
  ["Monthly retainer", "Retención mensual"],
  ["Time and materials", "Tiempo y materiales"],
